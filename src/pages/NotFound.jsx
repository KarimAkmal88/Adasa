...
export default function NotFound() {
  return (
    <div
      className="min-h-[calc(100vh-5rem)] flex items-center justify-center relative overflow-hidden bg-[#0a0a0a]"
      dir="rtl"
    >
      ...
      <div className="relative text-center px-4 max-w-lg mx-auto">
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-4 mb-12">
          <Link
            className="btn-primary rounded-full hover:-translate-y-1 inline-flex items-center justify-center gap-2"
            to="/"
          >
          ...
          <Link
            className="cursor-pointer p-8 font-semibold text-white transition-all duration-300 border rounded-full border-[#333] hover:text-orange-500 hover:border-orange-500 inline-flex items-center justify-center gap-2"
            to="/blog"
          >
